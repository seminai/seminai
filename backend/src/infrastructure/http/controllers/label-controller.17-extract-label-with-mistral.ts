...
import { extractStructuredTreatmentDataWithMistral } from '../../services/tool/extractDataFromLabel';
...
export async function labelControllerExtractLabelWithMistral(this: LabelControllerContext, request: Request, response: Response): Promise<Response> {
