...
export async function labelControllerBulkExtractFromPdfFilesFertilizerAsync(this: LabelControllerContext, request: Request, response: Response): Promise<Response> {
