...
import { PIEMONTE_COLUMN_MAPPING, parsePiemonteDate, parsePiemonteSuperficie, parseComuneDescrizione, extractCropCode, isNonAgriculturalUse as isPiemonteNonAgricultural } from '../file_agent/template/piemonte_file_structure';
...
export async function productionUnitCsvAgentExtractPiemonteFormat(this: ProductionUnitCsvAgentContext, rows: ParsedRow[]): Promise<ProductionUnitRaw[]> {
