...
import { VENETO_COLUMN_MAPPING, parseUsoSuoloFromOccupazione as parseVenetoUsoSuolo, parseVenetoDate, parseVenetoSuperficie, parseComuneDescrizione as parseVenetoComuneDescrizione, parseUnitaProduttiva as parseVenetoUnitaProduttiva, isNonAgriculturalUse as isVenetoNonAgricultural, getRegioneFromProvincia as getVenetoRegione, getRegioneFromComune as getVenetoRegioneFromComune } from './template/veneto_file_structure';
...
export function fieldCsvAgentExtractFieldsVenetoFormat(this: FieldCsvAgentContext, rows: ParsedRow[]): ExtractedFieldData {
