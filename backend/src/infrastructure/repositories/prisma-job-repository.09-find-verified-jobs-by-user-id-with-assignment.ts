...
export async function prismaJobRepositoryFindVerifiedJobsByUserIdWithAssignment(this: PrismaJobRepositoryContext, userId: string, companyName?: string, skip?: number, take?: number): Promise<{ jobs: JobWithAssignmentDTO[]; total: number }> {
