...
import { FindFieldNotesFilters, FieldNoteWithRelations } from '../../domain/repositories/IFieldNoteRepository';
import type { PrismaFieldNoteRepositoryContext } from './prisma-field-note-repository.context';

export async function prismaFieldNoteRepositoryFindAllWithRelations(this: PrismaFieldNoteRepositoryContext, filters: FindFieldNotesFilters): Promise<FieldNoteWithRelations[]> {
