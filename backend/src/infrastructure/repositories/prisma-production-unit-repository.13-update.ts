...
export async function prismaProductionUnitRepositoryUpdate(this: PrismaProductionUnitRepositoryContext, id: string, data: Partial<ProductionUnit>): Promise<ProductionUnit> {
