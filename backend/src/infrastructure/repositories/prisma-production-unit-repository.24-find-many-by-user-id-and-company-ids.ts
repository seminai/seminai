...
export async function prismaProductionUnitRepositoryFindManyByUserIdAndCompanyIds(this: PrismaProductionUnitRepositoryContext, userId: string, companyIds: string[]): Promise<
    Array<{
