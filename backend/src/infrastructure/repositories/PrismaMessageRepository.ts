...
export class PrismaMessageRepository implements IMessageRepository {
  ...
  async create(message: Message): Promise<Message> {
    const created = await this.prisma.message.create({
      data: {
        ...
        contentBlocks: message.contentBlocks as Prisma.InputJsonValue | undefined,
        status: message.status as PrismaAgentResponseStatus,
        pendingToolCalls: message.pendingToolCalls as Prisma.InputJsonValue | undefined,
        error: message.error,
        cost: message.cost as Prisma.InputJsonValue | undefined,
  ...
  static toDomainStatic(prismaMessage: PrismaMessage): Message {
    return new Message(
      ...
      (prismaMessage.pendingToolCalls as unknown[]) ?? undefined,
