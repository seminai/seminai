...
import { updateWorkingMemory, clearWorkingMemory, hasWorkingMemoryData } from '../infrastructure/services/agents/dosage_agent_react/working-memory';
  ...
  describe('Working Memory', () => {
    ...
    it('hasWorkingMemoryData should detect populated arrays', () => {
      updateWorkingMemory(threadId, {
        matchedProducts: [{ id: 'p1' }] as unknown as NonNullable<WorkingMemory['matchedProducts']>,
      });
